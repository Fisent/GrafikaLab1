...
public class WeirdStuff {
    ...
    public WeirdStuff(int width, int height, int fieldSize, String filename){
        x_res = width;
        y_res = height;
    ...
    public WeirdStuff(int width, int height, int fieldSize, String filename, int primaryColor, int secondaryColor){
        x_res = width;
        y_res = height;
        fieldSize = fieldSize;
        this.filename = filename;
